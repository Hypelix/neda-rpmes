                ...
                <div class="main-bar">
                    ...
                    <div class="row">
                      <div class="col-lg-4 input_field_sections">
                         ...
                         <input required type="text" class="form-control" name="test1" value="<?php echo $test1;?>"/>
                      </div>
                  ...
                  <div class="row">
										<div class="col-lg-4 input_field_sections">
											...
											<div >
												<input required="" type="text" class="form-control" name="test2" value="<?php echo $test2;?>" style="background:white">
                  ...
                  <div class="row">
                    <div class="col-lg-4 input_field_sections">
                       ...
                       <input required type="text" class="form-control" name="test3" value="<?php echo $test3;?>"/>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-4 input_field_sections">
                        ...
                        <input required="" type="text" class="form-control" name="test4" value="<?php echo $test4;?>" style="background-color: white;"/>
                      </div>
                  </div>
