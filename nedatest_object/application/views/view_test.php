                                            ...
                                            <tbody>
                                                ...
                                                if(!empty($getTest))
                                                {
													...
													{ ?>
                                                      ...
                                                      <td width="10%" style="text-align: center;"><?php echo anchor('Test_controller/delete_test?test_id='.$this->encryption->encrypt($value->test_id), 'DELETE', 'id="$value->test_id"');?></td>
                                                      <td width="10%"><?php echo anchor('Test_controller/update_test?test_id='.$this->encryption->encrypt($value->test_id), 'UPDATE', 'id="$value->test_id"');?></td>
