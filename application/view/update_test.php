         ...
         <div id="content" class="bg-container">
            <header class="head">
                <div class="main-bar">
                    ...
                    <input type="hidden" name="test_id" value="<?php echo $getTest[0]->test_id;?>"/> 
                    <div class="row">
                      <div class="col-lg-4 input_field_sections">
                          <h5>Test1<span style="color: #cc0000">*</span></h5>
                         <input required type="text" class="form-control" name="test1" value="<?php echo $getTest[0]->test1;?>"/>
                      </div>
                  ...
                  <div class="row">
										<div class="col-lg-4 input_field_sections">
											...
											<div >
												<input required="" type="text" class="form-control" name="test2" value="<?php echo $getTest[0]->test2;?>" style="background:white">
                  ...
                  <div class="row">
                    <div class="col-lg-4 input_field_sections">
                       ...
                       <input required type="text" class="form-control" name="test3" value="<?php echo $getTest[0]->test3;?>"/>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-4 input_field_sections">
                        ...
                        <input required="" type="text" class="form-control" name="test4" value="<?php echo $getTest[0]->test4;?>" style="background-color: white;"/>
                      </div>
                  </div>
